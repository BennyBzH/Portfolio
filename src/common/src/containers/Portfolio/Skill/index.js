  ...
  return (
    <Box {...sectionWrapper} as="section" id={id}>
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading {...secTitle} content="Comment puis-je vous aider ?" />
          <Text
            {...secDescription}
            content="Vous recherchez un développeur pour la réalisation de votre projet ?"
          />
          <Text
            {...secDescription}
            content="Voici mon panel de compétence"
          />
        </Box>
