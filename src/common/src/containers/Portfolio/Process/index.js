      ...
      <Container noGutter mobileGutter width="1200px">
        ...
        <Box {...learningRow}>
          <Box {...learningContentArea}>
            ...
            />
            <Text
              content = "Développeur web passionné, à la recherche d’opportunité en France."
              {...learningSubTitle}
            />
            <Text
              {...learningDescription}
              content = "Grâce à 2 années d’expérience, ainsi que des formations continuel, j’ai acquis les connaissances et les compétences nécessaire en développement web me permettant de réaliser toutes sortes de projets."
            />
            {/* <Text
              {...learningDescription}
